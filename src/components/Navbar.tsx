...
const Navbar = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { name: 'الفلسفة', href: '/philosophy', icon: <FaLightbulb className="w-4 h-4 text-yellow-500" /> },
    ...(user?.isAdmin
  ...
  return (
    <nav
      className={`fixed top-0 font-medium left-0 right-0 z-50 transition-all duration-500 ${scrolled
        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div className="text-right pl-2 ">
              <h1
                className={`text-xl font-bold ${scrolled ? 'text-slate-800' : 'text-white'
                  }`}
              >
                مركز التدريس
              </h1>
              <p
                className={`text-sm ${scrolled ? 'text-slate-600' : 'text-slate-300'
                  }`}
              >
                علم النفس والفلسفة
              </p>
              ...
              >
                {isLoading ? (
                  <Button
                    ...
                    isLoading>جاري تسجيل الخروج...</Button> // ✅ أثناء التحميل
                ) : (
                  <Link
          ...
          >
            <div className="px-4 py-6 space-y-3">
              ...
              {token && (
                ...
                >
                  {isLoading ? (
                    <ButtonMobile styles='lg:hidden flex' isLoading>جاري تسجيل الخروج...</ButtonMobile> // ✅ لودينج في الموبايل كمان
                  ) : (
                    <Link
                      to="#"
